...
namespace POS.Core.Domain.AmazonService
{
    ...
    /// </summary>
    public class OwnershipTransferDocumentDetailProcessingQueue
    {
        public long OwnershipTransferDocumentProcessingQueueID { get; set; }

        public long OwnershipTransferDocumentDetailID { get; set; }
