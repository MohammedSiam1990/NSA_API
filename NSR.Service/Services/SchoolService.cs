...
namespace NSR.Service.Services
{
    public class SchoolService : BaseService, ISchoolService
    {
        ...
        public SchoolService(UserManager<ApplicationUser> userManager,
        ...
        {
            PosService.SchoolRepository.AddSchool(School);
        }

        public void DeleteSchool(int SchoolId)
        {
            PosService.SchoolRepository.DeleteSchool(SchoolId);
        }

        public List<School> GetSchools()
        {
            return PosService.SchoolRepository.GetSchools();
        }

        public School GetSchool(int InsertedBy)
        {
            return PosService.SchoolRepository.GetSchool(InsertedBy);
        }
        ...
        public int SaveSchool(School School, string Img)
        {
            ...
            var result = PosService.SchoolRepository.SaveSchool(School, Img);
            if (result == 1)
            {
        ...
        {
            PosService.SchoolRepository.UpdateSchool(School);
        }

        public School ValidateAlreadyExist(School model)
        {
            return PosService.SchoolRepository.ValidateAlreadyExist(model);
        }

        public School GetSchoolID(int SchoolID)
        {
            return PosService.SchoolRepository.GetSchoolID(SchoolID);
        ...
        {
            return PosService.SchoolRepository.GetProSchoolsAll();
        }
    }
}
