...
namespace NSR.Service.Services
{
    public class SoldierService : BaseService, ISoldierService
    {
        ...
        public SoldierService(UserManager<ApplicationUser> userManager,
        ...
        {
            PosService.SoldierRepository.AddSoldier(Soldier);
        }

        public void DeleteSoldier(int SoldierId)
        {
            PosService.SoldierRepository.DeleteSoldier(SoldierId);
        }

        public List<Soldier> GetSoldiers()
        {
            return PosService.SoldierRepository.GetSoldiers();
        }
     
        public Soldier GetSoldier(int InsertedBy)
        {
            return PosService.SoldierRepository.GetSoldier(InsertedBy);
        }
        ...
        public int SaveSoldier(Soldier Soldier, string Img)
        {
            ...
            var result =              PosService.SoldierRepository.SaveSoldier(Soldier, Img);
            if (result == 1)
            {
        ...
        {
            PosService.SoldierRepository.UpdateSoldier(Soldier);
        }

        public Soldier ValidateAlreadyExist(Soldier model)
        {
            return PosService.SoldierRepository.ValidateAlreadyExist(model);
        }

        public Soldier GetSoldierID(int SoldierID)
        {
            return PosService.SoldierRepository.GetSoldierID(SoldierID);
        ...
        {
            return PosService.SoldierRepository.GetProSoldiersAll();
        }
    }
}
