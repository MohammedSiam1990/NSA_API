...
@Component({
  selector: 'app-modal-basic-two',
  templateUrl: './modal-basic-two.component.html',
  styleUrls: ['./modal-basic-two.component.css'],
...
export class ModalBasicTwoComponent implements OnInit, AfterViewInit, OnDestroy {
